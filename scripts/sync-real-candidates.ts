...
const REAL_GOVERNORS = [
  // Região Norte
  { tseId: 'gov_ac_jorge', name: 'Jorge Ney Viana Macedo Neves', socialName: 'Jorge Viana', viceName: 'Marcus Alexandre', party: 'PT', state: 'AC', municipality: 'Rio Branco', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Jorge_Viana_2015.jpg/400px-Jorge_Viana_2015.jpg' },
  { tseId: 'gov_ap_clecio', name: 'Clécio Luís Vilhena Vieira', socialName: 'Clécio Luís', viceName: 'Antônio Teles Júnior', party: 'SOLIDARIEDADE', state: 'AP', municipality: 'Macapá', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Cl%C3%A9cio_Lu%C3%ADs_em_2023.jpg/400px-Cl%C3%A9cio_Lu%C3%ADs_em_2023.jpg' },
  { tseId: 'gov_am_braga', name: 'Carlos Eduardo de Souza Braga', socialName: 'Eduardo Braga', viceName: 'Anne Moura', party: 'MDB', state: 'AM', municipality: 'Manaus', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Eduardo_Braga_em_2019.jpg/400px-Eduardo_Braga_em_2019.jpg' },
  { tseId: 'gov_pa_helder', name: 'Helder Zahluth Barbalho', socialName: 'Helder Barbalho', viceName: 'Hana Ghassan Tuma', party: 'MDB', state: 'PA', municipality: 'Belém', photoUrl: '/candidates/280001600007.jpg' },
  { tseId: 'gov_ro_daniel', name: 'Daniel Pereira', socialName: 'Daniel Pereira', viceName: 'Anselmo de Jesus', party: 'SOLIDARIEDADE', state: 'RO', municipality: 'Porto Velho', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Daniel_Pereira_2018.jpg/400px-Daniel_Pereira_2018.jpg' },
  { tseId: 'gov_rr_teresa', name: 'Maria Teresa Saenz Surita Jucá', socialName: 'Teresa Surita', viceName: 'Édio Lopes', party: 'MDB', state: 'RR', municipality: 'Boa Vista', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Teresa_Surita_2020.jpg/400px-Teresa_Surita_2020.jpg' },
  { tseId: 'gov_to_mourao', name: 'Paulo Roberto Mourão', socialName: 'Paulo Mourão', viceName: 'Professora Germana Pires', party: 'PT', state: 'TO', municipality: 'Palmas', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Paulo_Mour%C3%A3o_2018.jpg/400px-Paulo_Mour%C3%A3o_2018.jpg' },

  // Região Nordeste
  { tseId: 'gov_al_dantas', name: 'Paulo Suruagy do Amaral Dantas', socialName: 'Paulo Dantas', viceName: 'José Wanderley Neto', party: 'MDB', state: 'AL', municipality: 'Maceió', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Paulo_Dantas_2023.jpg/400px-Paulo_Dantas_2023.jpg' },
  ...
  { tseId: 'gov_ma_brandao', name: 'Carlos Orleans Brandão Júnior', socialName: 'Carlos Brandão', viceName: 'Felipe Camarão', party: 'PSB', state: 'MA', municipality: 'São Luís', photoUrl: '/candidates/280001600021.jpg' },
  ...
  { tseId: 'gov_pe_cabral', name: 'Danilo Jorge de Barros Cabral', socialName: 'Danilo Cabral', viceName: 'Luciana Santos', party: 'PSB', state: 'PE', municipality: 'Recife', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Danilo_Cabral_2019.jpg/400px-Danilo_Cabral_2019.jpg' },
  ...
  // Região Centro-Oeste
  { tseId: 'gov_df_grass', name: 'Leandro Antonio Grass Peixoto', socialName: 'Leandro Grass', viceName: 'Olgamir Amancia', party: 'PV', state: 'DF', municipality: 'Brasília', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Leandro_Grass_em_2023.jpg/400px-Leandro_Grass_em_2023.jpg' },
  { tseId: 'gov_go_wolmir', name: 'Wolmir Therezio Amado', socialName: 'Professor Wolmir Amado', viceName: 'Fernando Tibúrcio', party: 'PT', state: 'GO', municipality: 'Goiânia', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Wolmir_Amado_2022.jpg/400px-Wolmir_Amado_2022.jpg' },
  { tseId: 'gov_mt_natasha', name: 'Natasha Slhessarenko', socialName: 'Dra. Natasha Slhessarenko', viceName: 'Vinicius Hugueney', party: 'PSB', state: 'MT', municipality: 'Cuiabá', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Natasha_Slhessarenko_2022.jpg/400px-Natasha_Slhessarenko_2022.jpg' },
  { tseId: 'gov_ms_giselle', name: 'Giselle Marques de Araújo', socialName: 'Giselle Marques', viceName: 'Mário Fonseca', party: 'PT', state: 'MS', municipality: 'Campo Grande', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Giselle_Marques_2022.jpg/400px-Giselle_Marques_2022.jpg' },
  ...
  { tseId: 'gov_mg_silveira', name: 'Alexandre Silveira de Oliveira', socialName: 'Alexandre Silveira', viceName: 'Paulo Brant', party: 'PSD', state: 'MG', municipality: 'Belo Horizonte', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Alexandre_Silveira_2023.jpg/400px-Alexandre_Silveira_2023.jpg' },
  { tseId: 'gov_rj_paes', name: 'Eduardo da Costa Paes', socialName: 'Eduardo Paes', viceName: 'Eduardo Cavaliere', party: 'PSD', state: 'RJ', municipality: 'Rio de Janeiro', photoUrl: '/candidates/280001600006.jpg' },
  { tseId: 'gov_sp_franca', name: 'Márcio Luiz França Gomes', socialName: 'Márcio França', viceName: 'Juliano Medeiros', party: 'PSB', state: 'SP', municipality: 'São Paulo', photoUrl: '/candidates/280001600021.jpg' },

  // Região Sul
  { tseId: 'gov_pr_requiao', name: 'Roberto Requião de Mello e Silva', socialName: 'Roberto Requião', viceName: 'Jorge Samek', party: 'PT', state: 'PR', municipality: 'Curitiba', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Roberto_Requi%C3%A3o_em_2016.jpg/400px-Roberto_Requi%C3%A3o_em_2016.jpg' },
  { tseId: 'gov_rs_pretto', name: 'Edegar Pretto', socialName: 'Edegar Pretto', viceName: 'Pedro Ruas', party: 'PT', state: 'RS', municipality: 'Porto Alegre', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Edegar_Pretto_2023.jpg/400px-Edegar_Pretto_2023.jpg' },
  { tseId: 'gov_sc_decio', name: 'Décio Nery de Lima', socialName: 'Décio Lima', viceName: 'Marcio Búrigo', party: 'PT', state: 'SC', municipality: 'Florianópolis', photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/D%C3%A9cio_Lima_2023.jpg/400px-D%C3%A9cio_Lima_2023.jpg' },
];
