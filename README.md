...
| Serviço | Plano | Custo |
|---|---|---|
| API (NestJS) | Render free tier | $0 |
| Frontend (Expo Web) | Cloudflare Pages | $0 |
| Banco (PostgreSQL) | Supabase free tier | $0 |
| Builds (EAS) | Expo free tier | $0 |
...
```bash
# Clonar repositório
git clone https://github.com/fmourag/Eleicoes-Progressistas.git
cd Eleicoes-Progressistas
