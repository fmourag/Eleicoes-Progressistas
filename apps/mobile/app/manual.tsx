      ...
      >
          ...
          <View style={styles.supportButtonsGrid}>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.supportBtnSub, { color: colors.textMuted }]}>LGPD & Diretrizes v2.2.3</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.footerNotice}>
          <Text style={[styles.footerText, { color: colors.textMuted }]}>
            Eleições Progressistas v2.2.3 • Tecnologia Cívica Auditável • 100% Independente
          </Text>
        </View>
      </View>
    </ScrollView>
