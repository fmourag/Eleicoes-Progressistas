...
<body>
    <div class="header">
        <span class="badge">HOMOLOGAÇÃO v2.2.13</span>
...
<body>
    <div class="header">
        ...
        <p class="subtitle">Inscrição de Testadores Google Play & Homologação da versão 2.2.13</p>
    </div>
    ...
    <div class="card" id="formCard">
        ...
        <form id="feedbackForm">
            <input type="hidden" id="appVersion" name="appVersion" value="2.2.13">
    ...
    <div class="success-box" id="successBox">
        ...
        <p>Seu e-mail e apontamentos foram integrados à base de homologação da versão 2.2.13.</p>
