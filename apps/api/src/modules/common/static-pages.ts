...
<body>
    <div class="header">
        <span class="badge">BETA FECHADO v2.2.3</span>
        <h1>Eleições Progressistas 2026</h1>
        <p class="subtitle">Instalação direta para testadores e auditores cívicos</p>
    </div>

    <div class="qr-box">
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=https%3A%2F%2Fexpo.dev%2Fartifacts%2Feas%2FAuyFXRY-POmAo6xJK3cxvesMAHJlLPsK_m11pwQjSRc.apk" alt="QR Code Download APK">
        <p style="margin-bottom: 16px; color: #555;">Escaneie com a câmera do celular ou clique abaixo:</p>
        <a href="https://expo.dev/artifacts/eas/AuyFXRY-POmAo6xJK3cxvesMAHJlLPsK_m11pwQjSRc.apk" class="btn">⬇️ Baixar APK v2.2.3 (61,45 MB)</a>
    </div>
